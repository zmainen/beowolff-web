...
The Beowolff-Embed system fuses five distinct types of information into a single space. Each type enters through its own processing component (called a "tower"), and all five towers are trained together so that their outputs are compatible — they all produce points in the same 768-dimensional space.
